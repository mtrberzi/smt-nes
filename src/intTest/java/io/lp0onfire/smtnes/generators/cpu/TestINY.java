  ...
  public void testINY() throws IOException {
    ...
    exprs.addAll(reg.apply(new CodeGenerator(){
      ...
      public List<SExpression> generateCode(Map<String, Symbol> inputs,
        ...
        exprs.add(new Assertion(new EqualsExpression(X, new HexConstant("0F"))));
    ...
    CodeGenerator verifyX = new CodeGenerator() {
      ...
      public List<SExpression> generateCode(Map<String, Symbol> inputs,
        ...
        exprs.add(new EqualsExpression(X, new HexConstant("10")));
