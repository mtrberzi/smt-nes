...
public class TestTAY {
  ...
  public void testTAY() throws IOException {
    ...
    // check that Y = $5A
    CodeGenerator verifyY = new CodeGenerator() {
      ...
      public List<SExpression> generateCode(Map<String, Symbol> inputs,
        ...
        Symbol Y = inputs.get("CPU_Y");
        exprs.add(new EqualsExpression(Y, new HexConstant("5A")));
    ...
    for (SExpression expr : reg.apply(verifyY)) {
