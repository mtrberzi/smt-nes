  ...
  public void testSEC() throws IOException {
    ...
    exprs.addAll(reg.apply(new CodeGenerator(){
      ...
      public List<SExpression> generateCode(Map<String, Symbol> inputs,
        ...
        exprs.add(new Assertion(new EqualsExpression(P, new HexConstant("00"))));
    ...
    CodeGenerator verifyX = new CodeGenerator() {
      ...
      public List<SExpression> generateCode(Map<String, Symbol> inputs,
        ...
        exprs.add(new EqualsExpression(P, new BinaryConstant("00000001")));
