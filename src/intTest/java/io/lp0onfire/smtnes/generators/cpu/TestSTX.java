...
public class TestSTX {
  ...
  @Test
  public void testSTX_ZPG() throws IOException {
    // opcode 86
    ...
    exprs.addAll(reg.apply(new CodeGenerator(){
      ...
      public List<SExpression> generateCode(Map<String, Symbol> inputs,
        ...
        exprs.add(new Assertion(new EqualsExpression(X, new HexConstant("23"))));
  ...
  @Test
  public void testSTX_ZPY() throws IOException {
    // opcode 96
    ...
    exprs.addAll(reg.apply(new CodeGenerator(){
      ...
      public List<SExpression> generateCode(Map<String, Symbol> inputs,
        ...
        exprs.add(new Assertion(new EqualsExpression(Y, new HexConstant("08"))));
    ...
    // execute instruction
    // STX zero-page,y takes 4 cycles
  ...
  @Test
  public void testSTX_ABS() throws IOException {
    // opcode 8E
    
    // run the program
    // $0000: 8E 03 2A  STX $2A03
    // with X = $9B
    ...
    exprs.addAll(reg.apply(new CodeGenerator(){
      ...
      public List<SExpression> generateCode(Map<String, Symbol> inputs,
        ...
        Symbol X = outputs.get("CPU_X");
        exprs.add(new BitVectorDeclaration(X, new Numeral("8")));
        exprs.add(new Assertion(new EqualsExpression(X, new HexConstant("9B"))));
