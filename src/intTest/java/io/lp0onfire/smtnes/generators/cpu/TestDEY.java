  ...
  public void testDEY() throws IOException {
    ...
    exprs.addAll(reg.apply(new CodeGenerator(){
      ...
      public List<SExpression> generateCode(Map<String, Symbol> inputs,
        ...
        Symbol X = outputs.get("CPU_Y");
        exprs.add(new BitVectorDeclaration(X, new Numeral("8")));
        exprs.add(new Assertion(new EqualsExpression(X, new HexConstant("10"))));
    ...
    CodeGenerator verifyX = new CodeGenerator() {
      ...
      public List<SExpression> generateCode(Map<String, Symbol> inputs,
        ...
        Symbol X = inputs.get("CPU_Y");
        exprs.add(new EqualsExpression(X, new HexConstant("0F")));
